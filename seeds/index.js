...
const seedDB = async () => {
    ...
    for (let i = 0; i < 50; i++) {
        ...
        const camp = new Campground({
            ...
            description: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Expedita eum aliquid amet cupiditate ea voluptates sint nemo velit iusto, distinctio quaerat, ipsam non aperiam eius quasi ratione quam! Facilis, nobis?',
            price,
            images: [
                {
